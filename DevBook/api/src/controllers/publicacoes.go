...
//CriarPublicao adiciona uma nova publica no banco de dados
...
//DelatarPublicação excluir uma publicação
...
// BuscarPublicacoesPorUsuario traz todas a publicações de um usuário especifico
...
func CurtirPublicacao(w http.ResponseWriter, r *http.Request) {
	paramentros := mux.Vars(r)
	publicacaoId, erro := strconv.ParseUint(paramentros["publicacaoId"], 10, 64)
	if erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
